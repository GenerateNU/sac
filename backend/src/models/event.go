...
type Event struct {
	...
	Location  string    `gorm:"type:varchar(255)" json:"location" validate:"required,len<=255"`
	EventType EventType `gorm:"type:varchar(255);default:open" json:"event_type" validate:"required,len<=255"`
